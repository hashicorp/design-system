...
export declare enum HdsTextColorValues {
    Primary = "primary",
    Strong = "strong",
    Faint = "faint",
    Disabled = "disabled",
...
export declare enum HdsTextAlignValues {
    Left = "left",
    Center = "center",
    Right = "right"
}
export type HdsTextAligns = `${HdsTextAlignValues}`;
export declare enum HdsTextWeightValues {
    Regular = "regular",
    Medium = "medium",
    Semibold = "semibold",
    Bold = "bold"
...
export declare enum HdsTextSizeValues {
    FiveHundred = 500,
    FourHundred = 400,
    ThreeHundred = 300,
    TwoHundred = 200,
...
export declare enum HdsTextGroupValues {
    Code = "code",
    Display = "display",
    Body = "body"
}
