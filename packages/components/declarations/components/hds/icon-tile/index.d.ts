...
export default class HdsIconTileComponent extends Component<HdsIconTileSignature> {
     ...
     * @default null
     */
    get logo(): "boundary" | "consul" | "nomad" | "packer" | "terraform" | "vagrant" | "vault" | "vault-radar" | "vault-secrets" | "waypoint" | "hcp" | null;
    /**
