...
export default class HdsLinkStandaloneComponent extends Component<HdsLinkStandaloneSignature> {
     ...
     */
    get color(): "primary" | "secondary" | HdsLinkColorValues.Primary;
    /**
     * @param icon
     * @type {string|null}
     * @default null
     ...
     */
    get iconPosition(): "leading" | "trailing" | HdsLinkIconPositionValues.Leading;
    /**
     * @param size
     * @type {string}
     * @default medium
     ...
     */
    get size(): "small" | "medium" | "large" | HdsLinkStandaloneSizeValues.Medium;
    /**
     * @param iconSize
     * @type {string}
     * @default 16
