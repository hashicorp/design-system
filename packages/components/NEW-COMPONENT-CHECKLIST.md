...
A project kickoff will be schedule prior to the project start date. The kickoff will be used to align on project scope, timelines, and milestones, and as a space to discuss any open questions. In attendence should be Design System team leadership, lead Designer and Engineer on the project, Design/Engineer buddies (if applicable). 

## Design Checklist
The design checklist has 5 parts:
1. creating the branch
2. design and build component
3. testing
4. documentation
5. final release

The design process is largely cyclical, so some of these steps may need to be repeated until final approval.
...
- [ ] **design**
  ...
  - [ ] review with situationally appropriate stakeholders and iterate
    ...
    - reviews should include checks for: 
      ...
      - ux solution
      - fulfillment of requirements from CRD
      - a11y conformance
  ...
  - [ ] sync with your engineering partner in a pseudo handoff
    - let them know it's been approved and discuss any remaining questions
- [ ] **testing**
  - [ ] prepare for testing
    - [ ] lock the components
