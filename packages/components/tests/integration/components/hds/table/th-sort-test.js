...
module('Integration | Component | hds/table/th-sort', function (hooks) {
  ...
  test('it renders', async function (assert) {
    await render(
      hbs`<Hds::Table::ThSort @setSortBy={{this.setSortBy}} id="data-test-table-th-sort">Artist</Hds::Table::ThSort>`
    );
  ...
  test('if @sortOrder is not defined, the swap-vertical icon should be displayed', async function (assert) {
    await render(
      hbs`<Hds::Table::ThSort @sortBy='artist' @setSortBy={{this.setSortBy}} id="data-test-table-th-sort">Artist</Hds::Table::ThSort>`
    );
  ...
  test('if `@sortOrder` is set to asc, the arrow-up icon should be displayed', async function (assert) {
    await render(
      hbs`<Hds::Table::ThSort @sortBy='artist' @sortKey='artist' @sortOrder='asc' @setSortBy={{this.setSortBy}} id="data-test-table-th-sort">Artist</Hds::Table::ThSort>`
    );
