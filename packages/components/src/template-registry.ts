...
import type HdsFormKeyValuePairLabelComponent from './components/hds/form/key-value-pair/label.ts';
...
export default interface HdsComponentsRegistry {
  ...
  'hds/form/key-value-pair/label': typeof HdsFormKeyValuePairLabelComponent;
  'Hds::Form::KeyValuePair::Label': typeof HdsFormKeyValuePairLabelComponent;
