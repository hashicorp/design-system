...
import type HdsAccordionItemComponent from './components/hds/accordion/item/index.gts';
import type HdsAccordionItemButtonComponent from './components/hds/accordion/item/button.gts';
import type HdsAdvancedTableComponent from './components/hds/advanced-table/index.gts';
import type HdsAdvancedTableTdComponent from './components/hds/advanced-table/td.gts';
import type HdsAdvancedTableThButtonExpandComponent from './components/hds/advanced-table/th-button-expand.gts';
import type HdsAdvancedTableThButtonSortComponent from './components/hds/advanced-table/th-button-sort.gts';
import type HdsAdvancedTableThComponent from './components/hds/advanced-table/th.gts';
import type HdsAdvancedTableThButtonTooltipComponent from './components/hds/advanced-table/th-button-tooltip.gts';
import type HdsAdvancedTableThSortComponent from './components/hds/advanced-table/th-sort.gts';
import type HdsAdvancedTableThSelectableComponent from './components/hds/advanced-table/th-selectable.gts';
import type HdsAdvancedTableTrComponent from './components/hds/advanced-table/tr.gts';
import type HdsAdvancedTableExpandableTrGroupComponent from './components/hds/advanced-table/expandable-tr-group.gts';
import type HdsAlertComponent from './components/hds/alert/index.gts';
import type HdsAlertDescriptionComponent from './components/hds/alert/description.gts';
import type HdsAlertTitleComponent from './components/hds/alert/title.gts';
import type HdsAppHeaderComponent from './components/hds/app-header/index.gts';
import type HdsAppHeaderHomeLinkComponent from './components/hds/app-header/home-link.gts';
import type HdsAppHeaderMenuButtonComponent from './components/hds/app-header/menu-button.gts';
import type HdsAppFooterComponent from './components/hds/app-footer/index.gts';
import type HdsAppFooterCopyrightComponent from './components/hds/app-footer/copyright.gts';
import type HdsAppFooterItemComponent from './components/hds/app-footer/item.gts';
import type HdsAppFooterLegalLinksComponent from './components/hds/app-footer/legal-links.gts';
import type HdsAppFooterLinkComponent from './components/hds/app-footer/link.gts';
import type HdsAppFooterStatusLinkComponent from './components/hds/app-footer/status-link.gts';
import type HdsBadgeComponent from './components/hds/badge/index.gts';
import type HdsBadgeCountComponent from './components/hds/badge-count/index.gts';
import type HdsBreadcrumbComponent from './components/hds/breadcrumb/index.gts';
import type HdsBreadcrumbItemComponent from './components/hds/breadcrumb/item';
import type HdsBreadcrumbTruncationComponent from './components/hds/breadcrumb/truncation.gts';
import type HdsButtonComponent from './components/hds/button/index.gts';
import type HdsButtonSetComponent from './components/hds/button-set/index.gts';
import type HdsAppFrameComponent from './components/hds/app-frame/index.gts';
import type HdsAppFrameFooterComponent from './components/hds/app-frame/parts/footer.gts';
import type HdsAppFrameHeaderComponent from './components/hds/app-frame/parts/header.gts';
import type HdsAppFrameMainComponent from './components/hds/app-frame/parts/main.gts';
import type HdsAppFrameModalsComponent from './components/hds/app-frame/parts/modals.gts';
import type HdsAppFrameSidebarComponent from './components/hds/app-frame/parts/sidebar.gts';

import type HdsAppSideNavComponent from './components/hds/app-side-nav/index.gts';
import type HdsAppSideNavToggleButtonComponent from './components/hds/app-side-nav/toggle-button.gts';
import type HdsAppSideNavPortalComponent from './components/hds/app-side-nav/portal/index.gts';
import type HdsAppSideNavPortalTargetComponent from './components/hds/app-side-nav/portal/target.gts';
import type HdsAppSideNavListComponent from './components/hds/app-side-nav/list/index.gts';
import type HdsAppSideNavListBackLinkComponent from './components/hds/app-side-nav/list/back-link.gts';
import type HdsAppSideNavListItemComponent from './components/hds/app-side-nav/list/item.gts';
import type HdsAppSideNavListLinkComponent from './components/hds/app-side-nav/list/link.gts';
import type HdsAppSideNavListTitleComponent from './components/hds/app-side-nav/list/title.gts';

import type HdsApplicationStateComponent from './components/hds/application-state/index.gts';
import type HdsApplicationStateBodyComponent from './components/hds/application-state/body.gts';
import type HdsApplicationStateFooterComponent from './components/hds/application-state/footer.gts';
import type HdsApplicationStateHeaderComponent from './components/hds/application-state/header.gts';
import type HdsApplicationStateMediaComponent from './components/hds/application-state/media.gts';
import type HdsCardContainerComponent from './components/hds/card/container.gts';
import type HdsCodeEditorComponent from './components/hds/code-editor/index.gts';
import type HdsCodeEditorDescriptionComponent from './components/hds/code-editor/description.gts';
import type HdsCodeEditorGenericComponent from './components/hds/code-editor/generic.gts';
import type HdsCodeEditorTitleComponent from './components/hds/code-editor/title.gts';
import type HdsCodeEditorFullScreenButtonComponent from './components/hds/code-editor/full-screen-button.gts';
import type HdsCodeBlockComponent from './components/hds/code-block/index.gts';
import type HdsCodeBlockCopyButtonComponent from './components/hds/code-block/copy-button.gts';
import type HdsCodeBlockDescriptionComponent from './components/hds/code-block/description.gts';
import type HdsCodeBlockTitleComponent from './components/hds/code-block/title.gts';
import type HdsCopyButtonComponent from './components/hds/copy/button/index.gts';
import type HdsCopySnippetComponent from './components/hds/copy/snippet/index.gts';
import type HdsDisclosurePrimitiveComponent from './components/hds/disclosure-primitive/index.gts';
import type HdsDialogPrimitiveBodyComponent from './components/hds/dialog-primitive/body.gts';
import type HdsDialogPrimitiveDescriptionComponent from './components/hds/dialog-primitive/description.gts';
import type HdsDialogPrimitiveFooterComponent from './components/hds/dialog-primitive/footer.gts';
import type HdsDialogPrimitiveHeaderComponent from './components/hds/dialog-primitive/header.gts';
import type HdsDialogPrimitiveOverlayComponent from './components/hds/dialog-primitive/overlay.gts';
import type HdsDialogPrimitiveWrapperComponent from './components/hds/dialog-primitive/wrapper.gts';
import type HdsDismissButtonComponent from './components/hds/dismiss-button/index.gts';
import type HdsDropdownComponent from './components/hds/dropdown/index.gts';
import type HdsDropdownFooterComponent from './components/hds/dropdown/footer.gts';
import type HdsDropdownHeaderComponent from './components/hds/dropdown/header.gts';
import type HdsDropdownListItemCheckboxComponent from './components/hds/dropdown/list-item/checkbox.gts';
import type HdsDropdownListItemCheckmarkComponent from './components/hds/dropdown/list-item/checkmark.gts';
import type HdsDropdownListItemCopyItemComponent from './components/hds/dropdown/list-item/copy-item.gts';
import type HdsDropdownListItemDescriptionComponent from './components/hds/dropdown/list-item/description.gts';
import type HdsDropdownListItemGenericComponent from './components/hds/dropdown/list-item/generic.gts';
import type HdsDropdownListItemInteractiveComponent from './components/hds/dropdown/list-item/interactive.gts';
import type HdsDropdownListItemRadioComponent from './components/hds/dropdown/list-item/radio.gts';
import type HdsDropdownListItemSeparatorComponent from './components/hds/dropdown/list-item/separator.gts';
import type HdsDropdownListItemTitleComponent from './components/hds/dropdown/list-item/title.gts';
import type HdsDropdownToggleButtonComponent from './components/hds/dropdown/toggle/button.gts';
import type HdsDropdownToggleChevronComponent from './components/hds/dropdown/toggle/chevron.gts';
import type HdsDropdownToggleIconComponent from './components/hds/dropdown/toggle/icon.gts';
import type HdsFlyoutBodyComponent from './components/hds/flyout/body.gts';
import type HdsFlyoutDescriptionComponent from './components/hds/flyout/description.gts';
import type HdsFlyoutFooterComponent from './components/hds/flyout/footer.gts';
import type HdsFlyoutHeaderComponent from './components/hds/flyout/header.gts';
import type HdsFlyoutComponent from './components/hds/flyout/index.gts';
import type HdsFormCharacterCountComponent from './components/hds/form/character-count/index.gts';
import type HdsFormCheckboxBaseComponent from './components/hds/form/checkbox/base.gts';
import type HdsFormCheckboxFieldComponent from './components/hds/form/checkbox/field.gts';
import type HdsFormCheckboxGroupComponent from './components/hds/form/checkbox/group.gts';
import type HdsFormErrorComponent from './components/hds/form/error/index.gts';
import type HdsFormErrorMessageComponent from './components/hds/form/error/message.gts';
import type HdsFormFieldComponent from './components/hds/form/field/index.gts';
import type HdsFormFieldsetComponent from './components/hds/form/fieldset/index.gts';
import type HdsFormFileInputBaseComponent from './components/hds/form/file-input/base.gts';
import type HdsFormFileInputFieldComponent from './components/hds/form/file-input/field.gts';
import type HdsFormHelperTextComponent from './components/hds/form/helper-text/index.gts';
import type HdsFormIndicatorComponent from './components/hds/form/indicator/index.gts';
import type HdsFormLabelComponent from './components/hds/form/label/index.gts';
import type HdsFormLegendComponent from './components/hds/form/legend/index.gts';
import type HdsFormMaskedInputBaseComponent from './components/hds/form/masked-input/base.gts';
import type HdsFormMaskedInputFieldComponent from './components/hds/form/masked-input/field.gts';
import type HdsFormRadioBaseComponent from './components/hds/form/radio/base.gts';
import type HdsFormRadioFieldComponent from './components/hds/form/radio/field.gts';
import type HdsFormRadioGroupComponent from './components/hds/form/radio/group.gts';
import type HdsFormRadioCardComponent from './components/hds/form/radio-card/index.gts';
import type HdsFormRadioCardDescriptionComponent from './components/hds/form/radio-card/description.gts';
import type HdsFormRadioCardGroupComponent from './components/hds/form/radio-card/group.gts';
import type HdsFormRadioCardLabelComponent from './components/hds/form/radio-card/label.gts';
import type HdsFormSelectBaseComponent from './components/hds/form/select/base.gts';
import type HdsFormSelectFieldComponent from './components/hds/form/select/field.gts';
import type HdsFormSuperSelectAfterOptionsComponent from './components/hds/form/super-select/after-options.gts';
import type HdsFormSuperSelectOptionGroupComponent from './components/hds/form/super-select/option-group.gts';
import type HdsFormSuperSelectPlaceholderComponent from './components/hds/form/super-select/placeholder.gts';
import type HdsFormSuperSelectSingleBaseComponent from './components/hds/form/super-select/single/base.gts';
import type HdsFormSuperSelectSingleFieldComponent from './components/hds/form/super-select/single/field.gts';
import type HdsFormSuperSelectMultipleBaseComponent from './components/hds/form/super-select/multiple/base.gts';
import type HdsFormSuperSelectMultipleFieldComponent from './components/hds/form/super-select/multiple/field.gts';
import type HdsFormTextInputBaseComponent from './components/hds/form/text-input/base.gts';
import type HdsFormTextInputFieldComponent from './components/hds/form/text-input/field.gts';
import type HdsFormTextareaBaseComponent from './components/hds/form/textarea/base.gts';
import type HdsFormTextareaFieldComponent from './components/hds/form/textarea/field.gts';
import type HdsFormToggleBaseComponent from './components/hds/form/toggle/base.gts';
import type HdsFormToggleFieldComponent from './components/hds/form/toggle/field.gts';
import type HdsFormToggleGroupComponent from './components/hds/form/toggle/group.gts';
import type HdsFormVisibilityToggleComponent from './components/hds/form/visibility-toggle/index.gts';
import type HdsIconComponent from './components/hds/icon';
import type HdsIconTileComponent from './components/hds/icon-tile/index.gts';
import type HdsInteractiveComponent from './components/hds/interactive/index.gts';
import type HdsLayoutFlexComponent from './components/hds/layout/flex/index.gts';
import type HdsLayoutFlexItemComponent from './components/hds/layout/flex/item.gts';
import type HdsLayoutGridComponent from './components/hds/layout/grid/index.gts';
import type HdsLayoutGridItemComponent from './components/hds/layout/grid/item.gts';
import type HdsLinkInlineComponent from './components/hds/link/inline.gts';
import type HdsLinkStandaloneComponent from './components/hds/link/standalone.gts';
import type HdsMenuPrimitiveComponent from './components/hds/menu-primitive/index.gts';
import type HdsModalBodyComponent from './components/hds/modal/body.gts';
import type HdsModalFooterComponent from './components/hds/modal/footer.gts';
import type HdsModalHeaderComponent from './components/hds/modal/header.gts';
import type HdsModalComponent from './components/hds/modal/index.gts';
import type HdsPageHeaderComponent from './components/hds/page-header/index.gts';
import type HdsPageHeaderActionsComponent from './components/hds/page-header/actions.gts';
import type HdsPageHeaderBadgesComponent from './components/hds/page-header/badges.gts';
import type HdsPageHeaderDescriptionComponent from './components/hds/page-header/description.gts';
import type HdsPageHeaderSubtitleComponent from './components/hds/page-header/subtitle.gts';
import type HdsPageHeaderTitleComponent from './components/hds/page-header/title.gts';
import type HdsPaginationCompactComponent from './components/hds/pagination/compact/index.gts';
import type HdsPaginationControlInfoComponent from './components/hds/pagination/info/index.gts';
import type HdsPaginationControlArrowComponent from './components/hds/pagination/nav/arrow.gts';
import type HdsPaginationControlEllipsisComponent from './components/hds/pagination/nav/ellipsis.gts';
import type HdsPaginationControlNumberComponent from './components/hds/pagination/nav/number.gts';
import type HdsPaginationNumberedComponent from './components/hds/pagination/numbered/index.gts';
import type HdsPaginationSizeSelectorComponent from './components/hds/pagination/size-selector/index.gts';
import type HdsPopoverPrimitiveComponent from './components/hds/popover-primitive/index.gts';
import type HdsRevealComponent from './components/hds/reveal/index.gts';
import type HdsRevealToggleButtonComponent from './components/hds/reveal/toggle/button.gts';
import type HdsRichTooltipComponent from './components/hds/rich-tooltip/index.gts';
import type HdsRichTooltipBubbleComponent from './components/hds/rich-tooltip/bubble.gts';
import type HdsRichTooltipToggleComponent from './components/hds/rich-tooltip/toggle.gts';
import type HdsSegmentedGroupComponent from './components/hds/segmented-group/index.gts';
import type HdsSeparatorComponent from './components/hds/separator/index.gts';
import type HdsSideNavComponent from './components/hds/side-nav/index.gts';
import type HdsSideNavBaseComponent from './components/hds/side-nav/base.gts';
import type HdsSideNavToggleButtonComponent from './components/hds/side-nav/toggle-button.gts';
import type HdsSideNavPortalComponent from './components/hds/side-nav/portal/index.gts';
import type HdsSideNavPortalTargetComponent from './components/hds/side-nav/portal/target.gts';
import type HdsSideNavHeaderComponent from './components/hds/side-nav/header/index.gts';
import type HdsSideNavHeaderHomeLinkComponent from './components/hds/side-nav/header/home-link.gts';
import type HdsSideNavHeaderIconButtonComponent from './components/hds/side-nav/header/icon-button.gts';
import type HdsSideNavListComponent from './components/hds/side-nav/list/index.gts';
import type HdsSideNavListBackLinkComponent from './components/hds/side-nav/list/back-link.gts';
import type HdsSideNavListItemComponent from './components/hds/side-nav/list/item.gts';
import type HdsSideNavListLinkComponent from './components/hds/side-nav/list/link.gts';
import type HdsSideNavListTitleComponent from './components/hds/side-nav/list/title.gts';
import type HdsStepperListComponent from './components/hds/stepper/list/index.gts';
import type HdsStepperListStepComponent from './components/hds/stepper/list/step.gts';
import type HdsStepperNavComponent from './components/hds/stepper/nav/index.gts';
import type HdsStepperNavPanelComponent from './components/hds/stepper/nav/panel.gts';
import type HdsStepperNavStepComponent from './components/hds/stepper/nav/step.gts';
import type HdsStepperStepIndicatorComponent from './components/hds/stepper/step/indicator.gts';
import type HdsStepperTaskIndicatorComponent from './components/hds/stepper/task/indicator.gts';
import type HdsTableComponent from './components/hds/table/index.gts';
import type HdsTableTdComponent from './components/hds/table/td.gts';
import type HdsTableThButtonSortComponent from './components/hds/table/th-button-sort.gts';
import type HdsTableThComponent from './components/hds/table/th.gts';
import type HdsTableThButtonTooltipComponent from './components/hds/table/th-button-tooltip.gts';
import type HdsTableThSortComponent from './components/hds/table/th-sort.gts';
import type HdsTableThSelectableComponent from './components/hds/table/th-selectable.gts';
import type HdsTableTrComponent from './components/hds/table/tr.gts';
import type HdsTabsComponent from './components/hds/tabs/index.gts';
import type HdsTabsPanelComponent from './components/hds/tabs/panel.gts';
import type HdsTabsTabComponent from './components/hds/tabs/tab.gts';
import type HdsTextComponent from './components/hds/text/index.gts';
import type HdsTextBodyComponent from './components/hds/text/body.gts';
import type HdsTextDisplayComponent from './components/hds/text/display.gts';
import type HdsTagComponent from './components/hds/tag/index.gts';
import type HdsTooltipButtonComponent from './components/hds/tooltip-button/index.gts';
import type HdsToastComponent from './components/hds/toast/index.gts';
import type HdsTextCodeComponent from './components/hds/text/code.gts';
import type HdsTimeComponent from './components/hds/time/index.gts';
import type HdsTimeSingleComponent from './components/hds/time/single.gts';
import type HdsTimeRangeComponent from './components/hds/time/range.gts';
import type HdsYieldComponent from './components/hds/yield/index.gts';
...
export default interface HdsComponentsRegistry {
  ...
  'Hds::Stepper::Nav': typeof HdsStepperNavComponent;
  'hds/stepper/nav': typeof HdsStepperNavComponent;

  'Hds::Stepper::Nav::Panel': typeof HdsStepperNavPanelComponent;
  'hds/stepper/nav/panel': typeof HdsStepperNavPanelComponent;

  'Hds::Stepper::Nav::Step': typeof HdsStepperNavStepComponent;
  'hds/stepper/nav/step': typeof HdsStepperNavStepComponent;
