...
import HdsStepperNavStepComponent from './step.gts';
import { HdsStepperTitleTagValues } from '../types.ts';

import type { ComponentLike } from '@glint/template';
import type { HdsStepperNavStepSignature } from './step.gts';
import type { HdsStepperNavPanelSignature } from './panel.gts';
import type {
  HdsStepperTitleTags,
