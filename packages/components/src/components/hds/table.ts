...
import type { HdsTableTdSignature } from './table/td.ts';
import type { HdsTableThSignature } from './table/th.ts';
import type { HdsTableThSortSignature } from './table/th-sort.ts';
import type { HdsTableTrSignature } from './table/tr.ts';
