...
import type { HdsAppFooterItemSignature } from './app-footer/item.ts';
import type { HdsAppFooterLegalLinksSignature } from './app-footer/legal-links.ts';
import type { HdsAppFooterLinkSignature } from './app-footer/link.ts';
import type { HdsAppFooterStatusLinkSignature } from './app-footer/status-link.ts';
import type { HdsAppFooterThemeTypes } from './app-footer/types.ts';
