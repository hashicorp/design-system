...
import HdsSideNavBase from './base.gts';
import HdsSideNavToggleButton from './toggle-button.gts';

import type { HdsSideNavBaseSignature } from './base.gts';
...
export default class HdsSideNav extends Component<HdsSideNavSignature> {
  ...
  <template>
    ...
    <HdsSideNavBase
      class={{concat
        this.classNames
        (unless (has-block "header") " hds-side-nav--is-headerless")
      }}
      ...attributes
    ...
    >
      ...
      <:header as |Header|>
        {{~yield
          (hash Header=Header isMinimized=this.isMinimized)
          to="header"
        ~}}
      </:header>
      <:body as |Body|>
      ...
      <:footer as |Footer|>
        {{~yield
          (hash Footer=Footer isMinimized=this.isMinimized)
          to="footer"
        ~}}
      </:footer>
    </HdsSideNavBase>
