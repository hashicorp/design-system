...
import { SIZES, DEFAULT_SIZE, TYPES, DEFAULT_TYPE } from './accordion/item.ts';

import type { ComponentLike } from '@glint/template';
import { HdsAccordionItemTitleTagValues } from './accordion/types.ts';
import type { HdsAccordionItemSignature } from './accordion/item.ts';
import type {
