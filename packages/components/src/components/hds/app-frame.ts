...
import type { HdsAppFrameFooterSignature } from './app-frame/parts/footer.ts';
import type { HdsAppFrameHeaderSignature } from './app-frame/parts/header.ts';
import type { HdsAppFrameMainSignature } from './app-frame/parts/main.ts';
import type { HdsAppFrameModalsSignature } from './app-frame/parts/modals.ts';
import type { HdsAppFrameSidebarSignature } from './app-frame/parts/sidebar.ts';
