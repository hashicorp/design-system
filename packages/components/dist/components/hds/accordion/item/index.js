...
class HdsAccordionItemIndexComponent extends Component {
  /**
...
setComponentTemplate(TEMPLATE, HdsAccordionItemIndexComponent);

export { HdsAccordionItemIndexComponent as default };
