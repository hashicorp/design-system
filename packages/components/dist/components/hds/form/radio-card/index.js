...
class HdsFormRadioCard extends Component {
  /**
...
setComponentTemplate(TEMPLATE, HdsFormRadioCard);

export { ALIGNMENTS, CONTROL_POSITIONS, DEFAULT_ALIGNMENT, DEFAULT_CONTROL_POSITION, HdsFormRadioCard as default };
