...
class HdsFormSuperSelectSingleField extends Component {
  get idPrefix() {
    return ID_PREFIX;
  }
}
setComponentTemplate(TEMPLATE, HdsFormSuperSelectSingleField);

export { HdsFormSuperSelectSingleField as default };
