...
class HdsFormSuperSelectMultipleField extends Component {
  get idPrefix() {
    return ID_PREFIX;
  }
}
setComponentTemplate(TEMPLATE, HdsFormSuperSelectMultipleField);

export { HdsFormSuperSelectMultipleField as default };
