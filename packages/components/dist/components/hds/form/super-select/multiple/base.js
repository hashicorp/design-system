...
class HdsFormSuperSelectMultipleBase extends Component {
  static {
    g(this.prototype, "_powerSelectAPI", [tracked]);
  }
  #_powerSelectAPI = (i(this, "_powerSelectAPI"), undefined);
  static {
    g(this.prototype, "_showOnlySelected", [tracked], function () {
      return false;
    });
  }
  #_showOnlySelected = (i(this, "_showOnlySelected"), undefined);
  static {
    g(this.prototype, "_showNoSelectedMessage", [tracked], function () {
      return false;
    });
  }
  #_showNoSelectedMessage = (i(this, "_showNoSelectedMessage"), undefined);
