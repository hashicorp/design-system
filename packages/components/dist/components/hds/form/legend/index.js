...
class HdsFormLegendIndexComponent extends Component {
  /**
...
setComponentTemplate(TEMPLATE, HdsFormLegendIndexComponent);

export { HdsFormLegendIndexComponent as default };
