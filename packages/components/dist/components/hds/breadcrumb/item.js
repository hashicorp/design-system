...
class HdsBreadcrumbItemComponent extends Component {
  /**
   * @param maxWidth
   * @type {string}
   * @default undefined
...
setComponentTemplate(TEMPLATE, HdsBreadcrumbItemComponent);

export { HdsBreadcrumbItemComponent as default };
