...
class HdsInteractiveIndexComponent extends Component {
  /**
...
setComponentTemplate(TEMPLATE, HdsInteractiveIndexComponent);

export { HdsInteractiveIndexComponent as default };
