...
class HdsBadgeIndexComponent extends Component {
  /**
...
setComponentTemplate(TEMPLATE, HdsBadgeIndexComponent);

export { COLORS, DEFAULT_COLOR, DEFAULT_SIZE, DEFAULT_TYPE, SIZES, TYPES, HdsBadgeIndexComponent as default };
