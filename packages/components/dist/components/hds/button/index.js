...
class HdsButtonComponent extends Component {
  /**
   * @param text
   * @type {string}
...
setComponentTemplate(TEMPLATE, HdsButtonComponent);

export { COLORS, DEFAULT_COLOR, DEFAULT_ICONPOSITION, DEFAULT_SIZE, ICONPOSITIONS, SIZES, HdsButtonComponent as default };
