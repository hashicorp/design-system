...
class HdsAppFooterStatusLink extends Component {
  ...
  get statusIcon() {
    return this.args.statusIcon ?? (this.status !== undefined ? STATUSES[this.status]?.iconName : undefined);
  }
...
setComponentTemplate(TEMPLATE, HdsAppFooterStatusLink);

export { STATUSES, HdsAppFooterStatusLink as default };
