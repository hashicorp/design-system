...
class HdsPaginationNumberedIndexComponent extends Component {
  static {
    g(this.prototype, "_currentPage", [tracked], function () {
  ...
  static {
    g(this.prototype, "_currentPageSize", [tracked], function () {
