...
class SidenavPortalTarget extends Component {
  static {
  ...
  #numSubnavs = (i(this, "numSubnavs"), void 0);
  static {
    g(this.prototype, "lastPanelEl", [tracked], function () {
      return null;
    });
  }
  #lastPanelEl = (i(this, "lastPanelEl"), void 0);
