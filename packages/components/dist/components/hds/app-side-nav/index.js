...
class HdsAppSideNav extends Component {
  ...
  #_isMinimized = (i(this, "_isMinimized"), undefined);
  static {
    g(this.prototype, "_isAnimating", [tracked], function () {
      return false;
    });
  }
  #_isAnimating = (i(this, "_isAnimating"), undefined);
  static {
  ...
  _desktopMQ;
  _containersToHide;
  _desktopMQVal = getComputedStyle(document.documentElement).getPropertyValue('--hds-app-desktop-breakpoint');
