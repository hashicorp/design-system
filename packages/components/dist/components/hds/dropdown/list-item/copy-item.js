...
class HdsDropdownListItemCopyItem extends Component {
  /**
   * @param text
   * @type {string}
...
setComponentTemplate(TEMPLATE, HdsDropdownListItemCopyItem);

export { HdsDropdownListItemCopyItem as default };
