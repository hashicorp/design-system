...
class HdsAlertIndexComponent extends Component {
  static {
    g(this.prototype, "role", [tracked], function () {
      return 'alert';
    });
  }
  #role = (i(this, "role"), void 0);
  static {
    g(this.prototype, "ariaLabelledBy", [tracked]);
  }
  #ariaLabelledBy = (i(this, "ariaLabelledBy"), void 0);
...
setComponentTemplate(TEMPLATE, HdsAlertIndexComponent);

export { COLORS, DEFAULT_COLOR, MAPPING_COLORS_TO_ICONS, TYPES, HdsAlertIndexComponent as default };
