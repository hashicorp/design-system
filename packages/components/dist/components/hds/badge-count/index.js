...
class HdsBadgeCountIndexComponent extends Component {
  /**
...
setComponentTemplate(TEMPLATE, HdsBadgeCountIndexComponent);

export { COLORS, DEFAULT_COLOR, DEFAULT_SIZE, DEFAULT_TYPE, SIZES, TYPES, HdsBadgeCountIndexComponent as default };
