...
class HdsBadgeCount extends Component {
  /**
...
setComponentTemplate(TEMPLATE, HdsBadgeCount);

export { COLORS, DEFAULT_COLOR, DEFAULT_SIZE, DEFAULT_TYPE, SIZES, TYPES, HdsBadgeCount as default };
