...
class HdsStepperTaskIndicator extends Component {
  /**
   * @param status
   * @type {string}
   * @default "incomplete"
...
setComponentTemplate(TEMPLATE, HdsStepperTaskIndicator);

export { DEFAULT_STATUS, MAPPING_STATUS_TO_ICONS, STATUSES, HdsStepperTaskIndicator as default };
