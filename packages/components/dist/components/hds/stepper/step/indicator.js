...
class HdsStepperStepIndicator extends Component {
  /**
   * @param status
   * @type {string}
   * @default "incomplete"
...
setComponentTemplate(TEMPLATE, HdsStepperStepIndicator);

export { DEFAULT_STATUS, STATUSES, HdsStepperStepIndicator as default };
