...
class MenuPrimitive extends Component {
  ...
  #toggleRef = (i(this, "toggleRef"), undefined); // notice: if in the future we need to add a "@isOpen" prop to control the status from outside (eg to have the MenuPrimitive opened on render) just add  "this.args.isOpen" here to initalize the variable
  static {
    g(this.prototype, "element", [tracked]);
  }
  #element = (i(this, "element"), undefined);
