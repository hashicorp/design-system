...
function _setup(element, positional, named) {
  _assertClassBrand(_HdsTooltipModifier_brand, this, _createPopoverContainer).call(this, element);
...
function _createPopoverContainer(element) {
