        ...
        return (
            ...
            >
                ...
                <path
                    fill={color}
                    fillRule="evenodd"
                    d="M13.75 1A2.25 2.25 0 0116 3.25v9.5A2.25 2.25 0 0113.75 15H2.25A2.25 2.25 0 010 12.75v-9.5A2.25 2.25 0 012.25 1h11.5zM2.25 2.5a.75.75 0 00-.75.75v7.075l4.11-2.467.024-.012a.749.749 0 01.572-.068L9.08 8.6l1.328-2.988-.9.406a.75.75 0 01-.614-1.369l2.579-1.16a.75.75 0 01.99.376l1.162 2.58a.75.75 0 01-1.368.615l-.428-.952-1.638 3.687a.75.75 0 01-.908.423L6.106 9.31 1.5 12.074v.676c0 .414.336.75.75.75H5V13a.75.75 0 011.5 0v.5h3V13a.75.75 0 011.5 0v.5h2.75a.75.75 0 00.75-.75v-9.5a.75.75 0 00-.75-.75H2.25z"
                    clipRule="evenodd"
                />
            </svg>
        );
