        ...
        return (
            ...
            >
                ...
                <path
                    fill={color}
                    fillRule="evenodd"
                    d="M11.633 3.096a.75.75 0 0 1 .734 0l10.25 5.75a.752.752 0 0 1 0 1.308l-2.82 1.582a.75.75 0 0 1 .203.514v5q0 .15-.058.289l-.692-.29c.63.263.686.289.691.29v.005l-.003.006-.007.014-.02.044q-.024.052-.07.133a4 4 0 0 1-.269.42 5.6 5.6 0 0 1-1.21 1.193C17.2 20.21 15.312 21 12.346 21c-2.968 0-5.007-.79-6.319-1.615a7.6 7.6 0 0 1-1.426-1.147 5 5 0 0 1-.466-.558l-.009-.014-.003-.005-.002-.002c.006-.004.061-.042.629-.41l-.63.408A.75.75 0 0 1 4 17.25v-5a.75.75 0 0 1 .203-.514l-2.82-1.582a.751.751 0 0 1 0-1.308zm.734 12.808a.75.75 0 0 1-.734 0L5.5 12.464v4.533q.07.085.183.202c.232.242.604.577 1.143.916 1.072.675 2.833 1.385 5.52 1.385s4.252-.71 5.128-1.354c.442-.325.721-.644.886-.87q.093-.127.14-.21v-4.602zM3.283 9.5 12 14.39l8.717-4.89L12 4.61z"
                    clipRule="evenodd"
                />
            </svg>
        );
