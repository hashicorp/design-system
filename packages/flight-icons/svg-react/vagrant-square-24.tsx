...
export const IconVagrantSquare24 = forwardRef<SVGSVGElement, IconProps>(
        ...
        return (
            ...
            >
                ...
                <g fill={color}>
                    <path
                        fillRule="evenodd"
                        d="M17.08 4.75l-3.156 1.83v1.123L12 12.244l-1.924-4.54V6.58L6.92 4.75 5 5.864v1.293l4.276 10.514L12 19.25v-3.938l1.28-.742 2.563-5.752V7.693L19 5.865v-.001L17.08 4.75zm-7.004 1.83v1.123L12 12.244v1.583l-1.28.742-2.565-5.752V7.693l1.921-1.113z"
                        clipRule="evenodd"
                    />
                    <path
                        d="M19 5.865l-3.157 1.828v1.125L13.28 14.57l-1.28.742v3.938l2.724-1.578L19 7.158V5.865zM10.076 7.703V6.58l-1.92 1.113v1.124l2.564 5.752 1.28-.742v-1.583l-1.924-4.54z"
                        opacity={0.7}
                    />
                </g>
            </svg>
