    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <path
                    fill={color}
                    d="M4 1a3 3 0 0 1 2.585 4.524L8 6.94l4.803-4.803a.75.75 0 0 1 1.06 1.061l-7.278 7.278a3 3 0 1 1-1.062-1.06L6.94 8 5.523 6.585A3 3 0 1 1 4 1m5.116 8.123a.75.75 0 0 1 1.06-.001l3.687 3.68a.75.75 0 0 1-1.06 1.062l-3.686-3.68a.75.75 0 0 1 0-1.061M4 10.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3m0-8a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3"
                />
            </svg>
        );
    }
