...
export const IconHcpSquare24 = forwardRef<SVGSVGElement, IconProps>(
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <g fill={color}>
                    <path d="M10.835 4.6 5 7.96v8.074l2.192 1.264V9.224l3.643-2.1z" />
                    <path d="M13.165 4.6v6.43h-2.33v-2.4L8.642 9.894v8.237l2.193 1.266v-6.41h2.33v2.383l2.192-1.264V5.864z" />
                    <path d="M13.165 19.4 19 16.04V7.966l-2.193-1.264v8.074l-3.642 2.1z" />
                    <path
                        fillRule="evenodd"
