    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <g fill={color}>
                    <path d="M12.006 19A7 7 0 1 1 16.74 6.85l-1.66 1.738a4.6 4.6 0 1 0 0 6.828l1.66 1.738A6.98 6.98 0 0 1 12.006 19M17.638 15.499a.573.573 0 1 1 0-1.147.573.573 0 0 1 0 1.147" />
                    <path d="M11.96 13.517a1.517 1.517 0 1 1-.012-3.034 1.517 1.517 0 0 1 .013 3.034M18.297 13.544a.574.574 0 1 1 0-1.148.574.574 0 0 1 0 1.148M16.59 13.472a.573.573 0 1 1 0-1.147.573.573 0 0 1 0 1.147M18.297 11.61a.573.573 0 1 1 0-1.146.573.573 0 0 1 0 1.146M16.59 11.675a.574.574 0 1 1 0-1.147.574.574 0 0 1 0 1.147M17.672 9.68a.574.574 0 1 1-.003-1.147.574.574 0 0 1 .003 1.148" />
                    <path
                        fillRule="evenodd"
