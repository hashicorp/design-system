...
export const IconHcpSquareColor16 = forwardRef<SVGSVGElement, IconProps>(
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <g fill="#000">
                    <path d="m3.625 5.475 3.647-2.1v1.578L4.995 6.265v5.046l-1.37-.79z" />
                    <path d="M8.728 3.375v4.018H7.272v-1.5l-1.37.79v5.149l1.37.791V8.616h1.456v1.49l1.37-.79V4.165z" />
                    <path d="m12.375 10.525-3.647 2.1v-1.578l2.276-1.312V4.689l1.371.79z" />
                    <path
                        fillRule="evenodd"
