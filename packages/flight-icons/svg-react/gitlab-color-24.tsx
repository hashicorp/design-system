    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <path
                    fill="#FC6D26"
                    d="M21.963 13.292L18.627 3.256a.383.383 0 00-.363-.255.383.383 0 00-.364.255l-2.217 6.669H8.316L6.1 3.256A.382.382 0 005.736 3a.382.382 0 00-.363.256L2.039 13.292a.736.736 0 00.276.833L12 21l9.683-6.875a.737.737 0 00.28-.833z"
                />
                <path
                    fill="#E24329"
                    d="M12 20.995l3.682-11.07-7.363-.001L12 20.994z"
                />
                <path
                    fill="#FC6D26"
                    d="M12 20.995L8.316 9.925l-5.154-.001L12 20.994z"
                />
                <path
                    fill="#FCA326"
                ...
                <path
                    fill="#FC6D26"
                    d="M12 20.995l3.682-11.07 5.163-.001L12 20.994z"
                />
                <path
                    fill="#FCA326"
