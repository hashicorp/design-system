...
export const IconTerraformSquare16 = forwardRef<SVGSVGElement, IconProps>(
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <g fill={color}>
                    <path d="M3.625 6.157V3l2.718 1.579v3.156zM6.64 4.762 9.36 6.34v3.157L6.64 7.92zM9.657 9.497V6.34l2.718-1.578V7.92zM6.64 11.421 9.36 13V9.843L6.64 8.265z" />
                    <path
                        fillRule="evenodd"
