        ...
        return (
            ...
            >
                ...
                <path
                    fill={color}
                    fillRule="evenodd"
                    d="M12 15c.205 0 .402.084.543.232l5.25 5.5a.75.75 0 0 1-1.086 1.035L12 16.836l-4.707 4.931a.75.75 0 0 1-1.086-1.035l5.25-5.5A.75.75 0 0 1 12 15m-9.25-4a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1 0-1.5zm5 0a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1 0-1.5zm5 0a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1 0-1.5zm5 0a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1 0-1.5zm5 0a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1 0-1.5zm-6.043-8.768a.751.751 0 0 1 1.086 1.035l-5.25 5.5a.75.75 0 0 1-1.086 0l-5.25-5.5a.75.75 0 0 1 1.086-1.035L12 7.164z"
                    clipRule="evenodd"
                />
            </svg>
        );
