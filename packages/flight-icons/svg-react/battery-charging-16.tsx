    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <path
                    fill={color}
                    d="M6.396 3.057a.75.75 0 1 1 1.208.887l-2.141 2.92L8.987 8.04a.752.752 0 0 1 .367 1.155l-2.75 3.75a.75.75 0 0 1-1.047.161.75.75 0 0 1-.161-1.048l2.141-2.92-3.524-1.175a.76.76 0 0 1-.478-.484.75.75 0 0 1 .11-.67zM2.75 3a.75.75 0 0 1 0 1.5h-.5a.75.75 0 0 0-.75.75v5.5c.001.414.337.75.75.75h.5a.75.75 0 0 1 0 1.5h-.5A2.25 2.25 0 0 1 0 10.75v-5.5A2.25 2.25 0 0 1 2.25 3zm8 0A2.25 2.25 0 0 1 13 5.25v5.5A2.25 2.25 0 0 1 10.75 13h-.5a.75.75 0 0 1 0-1.5h.5a.75.75 0 0 0 .75-.75v-5.5a.75.75 0 0 0-.75-.75h-.5a.75.75 0 0 1 0-1.5zm4 3a.75.75 0 0 1 .75.75v2.5a.75.75 0 0 1-.75.75.75.75 0 0 1-.75-.75v-2.5a.75.75 0 0 1 .75-.75"
                />
            </svg>
        );
    }
