...
export const IconHcpSquareColor24 = forwardRef<SVGSVGElement, IconProps>(
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <g fill="#000">
                    <path d="m5 7.96 5.835-3.36v2.525l-3.643 2.1v8.073L5 16.034z" />
                    <path d="M13.165 4.6v6.43h-2.33v-2.4L8.642 9.894v8.237l2.193 1.266v-6.41h2.33v2.383l2.192-1.264V5.864z" />
                    <path d="m19 16.04-5.835 3.36v-2.525l3.642-2.1V6.703L19 7.966z" />
                    <path
                        fillRule="evenodd"
