    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <path
                    fill="#DBDBDB"
                    d="M12 22.315l-6.553-4.542V7.21s2.45-.88 6.554-.88v15.985z"
                />
                <path
                    fill="#C6C6C6"
                    d="M12.01 6.33H12v15.972l6.496-4.53V7.21s-2.384-.88-6.487-.88z"
                />
                <path
                    fill="#3B3B63"
                ...
                <path
                    fill="#53537A"
                    d="M8.457 19.868l3.543 2.5.002-7.454H8.933l-.476 4.954z"
                />
                <path
                    fill="#BC9375"
                ...
                <path
                    fill="#53537A"
                    d="M10.208 8.493s-.46-2.197-.67-2.943c0 0-.284 2.366-1.416 3.5 0 0 .198.673.059.957 0 0-.391 3.357-.217 3.795.048.12.115.353.314.626l.47.326 1.254-.359.974-1.086.17 3.137.855.63V8.192c-.964.002-1.793.3-1.793.3z"
                />
                <path
                    fill="#333152"
