    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <path
                    fill={color}
                    d="M15.25 1c.966 0 1.75.784 1.75 1.75V3h1.25A2.75 2.75 0 0 1 21 5.75v14.5A2.75 2.75 0 0 1 18.25 23H5.75A2.75 2.75 0 0 1 3 20.25V5.75A2.75 2.75 0 0 1 5.75 3H7v-.25C7 1.784 7.784 1 8.75 1zm1.53 9.22a.75.75 0 0 0-1.06 0l-5.47 5.47-1.97-1.97a.75.75 0 1 0-1.06 1.06l2.5 2.5a.75.75 0 0 0 1.06 0l6-6a.75.75 0 0 0 0-1.06M8.75 2.5a.25.25 0 0 0-.25.25v1.5c0 .138.112.25.25.25h6.5a.25.25 0 0 0 .25-.25v-1.5a.25.25 0 0 0-.25-.25z"
                />
            </svg>
        );
    }
