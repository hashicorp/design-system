    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <path
                    fill="#FBBC05"
                    d="M7.615 8.763a5.646 5.646 0 00-5.32 3.823 5.608 5.608 0 001.91 6.252l2.52-2.513a2.156 2.156 0 01-1.256-2.272 2.165 2.165 0 011.843-1.833 2.174 2.174 0 012.285 1.249l2.52-2.505a5.654 5.654 0 00-4.502-2.201z"
                />
            </svg>
        );
    }
