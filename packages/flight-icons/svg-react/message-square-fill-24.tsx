    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <g fill={color}>
                    <path d="M13.75 12a.75.75 0 0 1 0 1.5h-7a.75.75 0 0 1 0-1.5zM11.75 9a.75.75 0 0 1 0 1.5h-5a.75.75 0 0 1 0-1.5zM16.75 6a.75.75 0 0 1 0 1.5h-10a.75.75 0 0 1 0-1.5z" />
                    <path
                        fillRule="evenodd"
