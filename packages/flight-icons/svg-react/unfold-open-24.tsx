    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <g fill={color}>
                    <path d="M12 2a.75.75 0 0 1 .543.232l5.25 5.5a.75.75 0 1 1-1.085 1.036L12 3.836 7.293 8.768a.75.75 0 0 1-1.086-1.036l5.25-5.5A.75.75 0 0 1 12 2M12 22a.75.75 0 0 0 .543-.232l5.25-5.5a.75.75 0 0 0-1.085-1.036L12 20.164l-4.707-4.932a.75.75 0 0 0-1.086 1.036l5.25 5.5A.75.75 0 0 0 12 22M1.25 11a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5zM6.25 11a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5zM11.25 11a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5zM16.25 11a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5zM21.25 11a.75.75 0 0 0 0 1.5h1.5a.75.75 0 0 0 0-1.5z" />
                </g>
            </svg>
        );
    }
