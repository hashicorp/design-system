    ...
    ({ color = 'currentColor', title, ...props }, svgRef) => {
        ...
        return (
            ...
            >
                ...
                <path
                    fill={color}
                    d="M16.855 3c.804 0 1.602.155 2.346.457a6.2 6.2 0 0 1 1.993 1.305 6 6 0 0 1 1.336 1.956 5.93 5.93 0 0 1 0 4.626 6 6 0 0 1-1.336 1.957l-8.67 8.485a.75.75 0 0 1-1.048 0l-8.67-8.485A5.97 5.97 0 0 1 1 9.03c0-1.604.651-3.14 1.806-4.27A6.2 6.2 0 0 1 7.146 3c1.624 0 3.185.631 4.338 1.76l.516.504.515-.503a6.2 6.2 0 0 1 1.993-1.305A6.3 6.3 0 0 1 16.855 3"
                />
            </svg>
        );
    }
