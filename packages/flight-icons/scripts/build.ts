...
import { generateBundleCSSProps } from './build-parts/generateBundleCSSProps';
...
async function build() {
    ...
    // generate the bundle for the CSS props
    console.log('Generating bundle for CSS properties');
    await generateBundleCSSProps({ config, catalog });
