...
const CarbonIconConnectionGateway24: TemplateOnlyComponent<CarbonIconSignature> =
    <template>
        {{#let (uniqueId) as |id|}}
            <svg
            ...
            >
                ...
                {{/if}}
                <circle cx='21' cy='26' r='2'></circle><circle
                    cx='21'
                    cy='6'
                    r='2'
                ></circle><circle cx='4' cy='16' r='2'></circle><path
...
export default CarbonIconConnectionGateway24;
