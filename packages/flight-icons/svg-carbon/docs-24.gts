...
const CarbonIconDocs24: TemplateOnlyComponent<CarbonIconSignature> = <template>
    {{#let (uniqueId) as |id|}}
        <svg
        ...
        >
            ...
            ></path><path d='M10 22H22V24H10zM10 16H22V18H10z'></path></svg>
    {{/let}}
</template>;

export default CarbonIconDocs24;
