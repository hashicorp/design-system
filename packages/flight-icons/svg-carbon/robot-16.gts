...
const CarbonIconRobot16: TemplateOnlyComponent<CarbonIconSignature> = <template>
    {{#let (uniqueId) as |id|}}
        <svg
        ...
        >
            ...
            {{/if}}
            <path d='M18 10H20V12H18zM12 10H14V12H12z'></path><path
...
export default CarbonIconRobot16;
