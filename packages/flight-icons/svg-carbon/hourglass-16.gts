...
const CarbonIconHourglass16: TemplateOnlyComponent<CarbonIconSignature> =
    <template>
        {{#let (uniqueId) as |id|}}
            <svg
            ...
            >
                ...
                {{/if}}
                <path d='M15 19H17V21H15zM15 23H17V25H15z'></path><path
...
export default CarbonIconHourglass16;
