...
Added the `hds-focus-ring-basic` and `hds-focus-ring-advnaced` sass mixins and removed the `hds-focus-ring-with-pseudo-element` and `hds-focus-ring-with-pseudo-element-focus-always-visible` sass mixins