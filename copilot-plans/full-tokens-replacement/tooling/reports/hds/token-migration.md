...
| `--token-form-radiocard-border-radius` | `--hds-form-radio-card-border-radius` | 1 |
| `--token-form-radiocard-border-width` | `--hds-form-radio-card-border-width` | 3 |
| `--token-form-radiocard-content-padding` | `--hds-form-radio-card-content-padding` | 1 |
| `--token-form-radiocard-control-padding` | `--hds-form-radio-card-control-padding` | 1 |
| `--token-form-radiocard-group-gap` | `--hds-form-radio-card-group-gap` | 2 |
| `--token-form-radiocard-transition-duration` | `--hds-form-radio-card-transition-duration` | 1 |
