...
module('Integration | Component | hds/form/field/index', function (hooks) {
  ...
  test('it should render the component with a CSS class provided via the @contextualClass argument', async function (assert) {
    await render(
      <template>
        <Field @contextualClass="my-class" id="test-form-field" />
      </template>,
    );
  ...
  test('it should render the correct DOM order when the @layout prop has value vertical', async function (assert) {
    await render(
      <template>
        <Field @layout="vertical" id="test-form-field" as |F|>
          <F.Label>This is the label</F.Label>
          <F.HelperText>This is the helper text</F.HelperText>
        </Field>
      </template>,
    );
    let control = find('#test-form-field .hds-form-field__control');
    let helperText = find('#test-form-field .hds-form-field__helper-text');
  ...
  test('it should render the correct DOM order when the @layout prop has value flag', async function (assert) {
    await render(
      <template>
        <Field @layout="flag" id="test-form-field" as |F|>
          <F.Label>This is the label</F.Label>
          <F.HelperText>This is the helper text</F.HelperText>
        </Field>
      </template>,
  ...
  test('it automatically provides all the ID relations between the elements', async function (assert) {
    ...
    let control = find('#test-form-field .hds-form-field__control pre');
