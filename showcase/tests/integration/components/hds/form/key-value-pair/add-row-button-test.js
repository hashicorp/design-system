...
module(
  'Integration | Component | hds/form/key-value-pair/add-row-button',
  function (hooks) {
    setupRenderingTest(hooks);

    test('it should render the component with a CSS class that matches the component name', async function (assert) {
      await render(
        hbs`<Hds::Form::KeyValuePair::AddRowButton id="test-form-key-value-add-row-button" />`,
      );
      assert
        .dom('#test-form-key-value-add-row-button')
        .hasClass('hds-form-key-value-pair__add-row-button');
    });
    ...
    test('it should render text from `@text` argument', async function (assert) {
      await render(
        hbs`<Hds::Form::KeyValuePair::AddRowButton @text="Custom text" id="test-form-key-value-add-row-button" />`,
      );
    ...
    test('it should call `@onClick` action when clicked', async function (assert) {
      ...
      await render(
        hbs`<Hds::Form::KeyValuePair::AddRowButton @onClick={{this.onClick}} id="test-form-key-value-add-row-button" />`,
      );
