...
module('Integration | Component | hds/form/index', function (hooks) {
  ...
  // using "form" tag
  test('with tag=form, it should yield the Header, HeaderTitle, HeaderDescription, Section, SectionHeader, SectionHeaderTitle, SectionHeaderDescription, SectionFieldGroup, Separator, and ButtonSet children', async function (assert) {
    await render(
      hbs`<Hds::Form id="test-form" @tag="form" as |FORM|>
            <FORM.Header>
              <FORM.HeaderTitle />
  ...
  // using "div" tag
  test('with tag=div, it should yield the Header, HeaderTitle, HeaderDescription, Section, SectionHeader, SectionHeaderTitle, SectionHeaderDescription, SectionFieldGroup, Separator, and ButtonSet children', async function (assert) {
    await render(
      hbs`<Hds::Form id="test-form" @tag="form" as |FORM|>
            <FORM.Header>
              <FORM.HeaderTitle />
