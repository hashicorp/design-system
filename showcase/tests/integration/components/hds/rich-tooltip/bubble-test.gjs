...
import Bubble from "@hashicorp/design-system-components/components/hds/rich-tooltip/bubble";
...
module('Integration | Component | hds/rich-tooltip/bubble', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      <template><Bubble @popoverId="test-rich-tooltip-bubble" /></template>,
    );
    assert
  ...
  test('it should render some elements but not the yielded content by default', async function (assert) {
    await render(<template>
      <Bubble @popoverId="test-rich-tooltip-bubble" @arrowId="test-rich-tooltip-bubble-arrow">
  ...
  test('it should render the container with the provided with/height', async function (assert) {
    await render(<template>
      <Bubble @width="123px" @height="456px" @isOpen={{true}} />
    </template>);
  ...
  test('it should return the default values for the `anchoredPositionOptions` object', async function (assert) {
    ...
    await render(
      <template><Bubble @popoverId="test-rich-tooltip-bubble" @arrowId="test-rich-tooltip-arrow" @setupPrimitivePopover={{this.fakeSetupPrimitivePopover}} /></template>,
    );
  ...
  test('it should return the values provided via arguments for the `anchoredPositionOptions` object', async function (assert) {
    ...
    await render(
      <template><Bubble @popoverId="test-rich-tooltip-bubble" @arrowId="test-rich-tooltip-arrow" @placement="top-start" @offsetOptions={{123}} @enableCollisionDetection={{false}} @arrowSelector="#test-arrow-selector" @arrowPadding={{987}} @setupPrimitivePopover={{this.fakeSetupPrimitivePopover}} /></template>,
    );
    assert.deepEqual(anchoredPositionOptions, {
      anchoredPositionOptions: {
        arrowPadding: 12,
  ...
  test('it should not override the ID value provided with @popoverId with an attribute', async function (assert) {
    await render(
      <template><Bubble @popoverId="test-rich-tooltip-bubble" id="the-other-id" /></template>,
    );
    assert
      .dom('.hds-rich-tooltip__bubble')
      .hasAttribute('id', 'test-rich-tooltip-bubble');
  ...
  test('it should have a set of attributes based on the arguments provided', async function (assert) {
    await render(
      <template><Bubble @popoverId="popoverId" @isOpen={{true}} /></template>,
    );
    ...
    await render(
      <template><Bubble id="test-rich-tooltip-bubble" /></template>,
    );
  ...
  skip('it should throw an assertion if an incorrect value for @placement is provided', async function (assert) {
    ...
    await render(
      <template><Bubble @placement="foo" @setupPrimitivePopover={{this.fakeSetupPrimitivePopover}} /></template>,
    );
