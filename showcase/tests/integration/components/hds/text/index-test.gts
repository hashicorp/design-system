...
module('Integration | Component | hds/text/index', function (hooks) {
  ...
  test('it should render with a CSS class that matches the component name', async function (assert) {
    await render(
      <template>
        <Text @group="body" @size="200" @tag="p" id="test-text" />
      </template>,
    );
  ...
  test('it renders with the provided text', async function (assert) {
    await render(
      <template>
        <Text @group="body" @size="200" @tag="p" id="test-text">This is the text</Text>
      </template>,
    );
  ...
  test('it should render text with the correct variant based on the @group/@size declared', async function (assert) {
    await render(
      <template>
        <Text @group="display" @size="500" @tag="p" id="test-text">This is the
          text</Text>
      </template>,
    );
  ...
  test('it should render text with a "span" element if @tag is not declared', async function (assert) {
    await render(
      <template>
        <Text @group="body" @size="200" id="test-text">This is the text</Text>
      </template>,
    );
  ...
  test('it should render text with the correct @tag declared', async function (assert) {
    await render(
      <template>
        <Text @group="body" @tag="mark" @size="200" id="test-text">This is the
          text</Text>
      </template>,
    );
