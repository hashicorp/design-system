...
import List from "@hashicorp/design-system-components/components/hds/side-nav/list/index";
...
module('Integration | Component | hds/side-nav/list/index', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(<template><List id="test-side-nav-list-wrapper" /></template>);
    assert
