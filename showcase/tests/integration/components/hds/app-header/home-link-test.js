...
module('Integration | Component | hds/app-header/home-link', function (hooks) {
  ...
  // DISABLEtest('it renders the logo with a custom passed in color', async function (assert) {
  //   await render(
  ...
  // DISABLEtest('it should throw an assertion if @ariaLabel is missing/has no value', async function (assert) {
  //   const errorMessage =
