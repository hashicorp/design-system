...
const startReorderDrag = async (handleElement: Element | null) => {
  ...
  console.log('handle element exists');
...
const simulateColumnReorderDrag = async ({
  ...
  console.log(handleElement, 'handle element passed in');
  ...
  console.log(handleElement, 'handle element found');
