...
module('Integration | Component | hds/advanced-table/th', function (hooks) {
  ...
  test('it should render with a CSS class that matches the component name', async function (assert) {
    await render(
      <template>
        <HdsAdvancedTableTh id="data-advanced-test-table-th">
          Artist
        </HdsAdvancedTableTh>
      </template>,
    );
  ...
  test('it should render with the appropriate `@align` CSS class', async function (assert) {
    await render(
      <template>
        <HdsAdvancedTableTh id="data-advanced-test-table-th" @align="right">
          Artist
        </HdsAdvancedTableTh>
      </template>,
    );
  ...
  test('it should render with the appropriate span information by default', async function (assert) {
    await render(
      <template>
        <HdsAdvancedTableTh id="data-test-advanced-table-th" />
      </template>,
    );
  ...
  test('it should support splattributes', async function (assert) {
    await render(
      <template>
        <HdsAdvancedTableTh id="data-advanced-test-table-th" lang="es">
          Artist
        </HdsAdvancedTableTh>
      </template>,
    );
  ...
  test('it has the role rowheader if inside a tbody', async function (assert) {
    ...
    await render(
      <template>
        <HdsAdvancedTable @model={{model}} @columns={{columns}}>
          <:body as |B|>
            <B.Tr>
              <B.Th id="data-advanced-test-table-th">Artist</B.Th>
            </B.Tr>
          </:body>
        </HdsAdvancedTable>
      </template>,
