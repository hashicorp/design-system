...
module(
  ...
  function (hooks) {
    ...
    test('it renders with a CSS class that matches the component name', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort id="data-test-advanced-table-th-sort">Artist</Hds::AdvancedTable::ThSort>`
      );
      ...
      assert
        .dom('#data-test-advanced-table-th-sort .hds-table__th-button--sort')
        .exists();
    });
    ...
    test('it renders text content yielded within the cell', async function (assert) {
      ...
      assert
        .dom('#data-test-advanced-table-th-sort .hds-table__th-content > span')
        .hasText('Artist');
    });
    ...
    test('it should render with the appropriate `@align` CSS class', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort id="data-test-advanced-table-th-sort" @align="right">Year</Hds::AdvancedTable::ThSort>`
      );
      assert
        .dom('#data-test-advanced-table-th-sort')
    ...
    test('if @sortOrder is not defined, the swap-vertical icon should be displayed', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort @sortBy='artist'>Artist</Hds::AdvancedTable::ThSort>`
      );
    ...
    test('if sorted, and `@sortOrder` is set, the correct icon should be displayed', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort @sortOrder='asc'>Artist</Hds::AdvancedTable::ThSort>`
      );

      assert.dom('[data-test-icon="arrow-up"]').exists();

      await render(
        hbs`<Hds::AdvancedTable::ThSort @sortOrder='desc'>Artist</Hds::AdvancedTable::ThSort>`
      );
    ...
    test('it should support splattributes', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort id="data-test-table-th" lang="es">Artist</Hds::AdvancedTable::ThSort>`
      );
    ...
    test('it has the `scope` attribute, and it is set to column by default', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort>Artist</Hds::AdvancedTable::ThSort>`
      );
    ...
    test('the default `scope` attribute can not be overwritten', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort scope="row">Artist</Hds::AdvancedTable::ThSort>`
      );
    ...
    test('if unsorted, the aria-sort attribute value should be set to none', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort @sortBy='artist' id="data-test-advanced-table-th-sort">Artist</Hds::AdvancedTable::ThSort>`
      );
    ...
    test('if sorted, the aria-sort attribute value should reflect the direction', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort @sortBy='artist' @sortOrder="desc" id="data-test-advanced-table-th-sort">Artist</Hds::AdvancedTable::ThSort>`
      );
    ...
    test('it renders the `aria-labelledby` attribute for the sort button with the correct IDs', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort id="data-test-advanced-table-th-sort" @sortBy='artist' @sortOrder="desc">Artist</Hds::AdvancedTable::ThSort>`
      );
      const prefixLabel = this.element.querySelector(
        '#data-test-advanced-table-th-sort .hds-table__th-button-aria-label-hidden-segment:nth-of-type(1)'
      );
      const buttonLabel = this.element.querySelector(
        '#data-test-advanced-table-th-sort .hds-table__th-content > span'
      );
      const suffixLabel = this.element.querySelector(
        '#data-test-advanced-table-th-sort .hds-table__th-button-aria-label-hidden-segment:nth-of-type(2)'
      );
      assert
        .dom('#data-test-advanced-table-th-sort .hds-table__th-button--sort')
        .hasAria(
    ...
    test('it should call the `@onClickSort` function if provided', async function (assert) {
      ...
      await render(
        hbs`<Hds::AdvancedTable::ThSort id="data-test-advanced-table-th-sort" @onClickSort={{this.onClickSort}}>Artist</Hds::AdvancedTable::ThSort>`
      );
      await click(
        '#data-test-advanced-table-th-sort .hds-table__th-button--sort'
      );
      assert.ok(isClicked);
    });
    ...
    test('if @tooltip is undefined a tooltip button toggle should not be present', async function (assert) {
      ...
      assert
        .dom('#data-test-advanced-table-th-sort .hds-table__th-button--tooltip')
        .doesNotExist();
    });
    test('if @tooltip is defined a tooltip should be added to the table cell header', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort @tooltip="More info." id="data-test-advanced-table-th-sort">Artist</Hds::AdvancedTable::ThSort>`
      );
      ...
      await focus(
        '#data-test-advanced-table-th-sort .hds-table__th-button--tooltip'
      );
    ...
    test('it renders the `aria-labelledby` attribute for the tooltip button with the correct IDs', async function (assert) {
      await render(
        hbs`<Hds::AdvancedTable::ThSort id="data-test-advanced-table-th-sort" @tooltip="More info.">Artist</Hds::AdvancedTable::ThSort>`
      );
      let prefixLabel = this.element.querySelector(
        '#data-test-advanced-table-th-sort .hds-table__th-button-aria-label-hidden-segment'
      );
