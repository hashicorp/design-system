...
module('Integration | Component | hds/app-side-nav/portal', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      <template>
        <HdsAppSideNavPortalTarget id="test-app-side-nav-portal-target" />
      </template>,
    );
    assert
  ...
  test('we can use custom a custom name for the target portal', async function (assert) {
    await render(
      <template>
        ...
        />
        <HdsAppSideNavPortal @targetName="test-app-side-nav-portal-target">
          <div id="test-app-side-nav-content-portaled" />
        </HdsAppSideNavPortal>
      </template>,
    );
  ...
  test('it renders the panel items provided via portal, in the right DOM location', async function (assert) {
    await render(
      <template>
        <HdsAppSideNavPortalTarget id="test-app-side-nav-content" />
  ...
  test('it should render with the correct aria-label attribute passed down to the "list" parent', async function (assert) {
    await render(
      <template>
        <HdsAppSideNavPortalTarget />
        <HdsAppSideNavPortal @ariaLabel="test">
          <div />
        </HdsAppSideNavPortal>
      </template>,
    );
  ...
  test('it marks inactive subnavs', async function (assert) {
    await render(
      <template>
        <HdsAppSideNavPortalTarget />
        <HdsAppSideNavPortal data-test-app-side-nav-panel as |Nav|>
      ...
      <template>
        ...
        <HdsAppSideNavPortal as |Nav|>
          <Nav.Link
            ...
            @href="#"
            id="test-app-side-nav-list-link-1"
            data-test-app-side-nav-link-2
          />
        </HdsAppSideNavPortal>
        <HdsAppSideNavPortal as |Nav|>
          <Nav.Link
            ...
            @href="#"
            id="test-app-side-nav-list-link-2"
            data-test-app-side-nav-link-2
          />
        </HdsAppSideNavPortal>
        <HdsAppSideNavPortal as |Nav|>
          <Nav.Link
            ...
            @href="#"
            id="test-app-side-nav-list-link-3"
            data-test-app-side-nav-link-3
          />
        </HdsAppSideNavPortal>
      </template>,
    );
