...
import Target from "@hashicorp/design-system-components/components/hds/app-side-nav/portal/target";
import Portal from "@hashicorp/design-system-components/components/hds/app-side-nav/portal/index";
...
module('Integration | Component | hds/app-side-nav/portal', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      <template><Target id="test-app-side-nav-portal-target" /></template>,
    );
    assert
...
<Portal>
  ...
  test('we can use custom a custom name for the target portal', async function (assert) {
    await render(<template><Target @targetName="test-app-side-nav-portal-target" />
<Portal @targetName="test-app-side-nav-portal-target">
  <div id="test-app-side-nav-content-portaled" />
</Portal></template>);
    assert.dom('#test-app-side-nav-content-portaled').exists();
  });
  ...
  test('it renders the panel items provided via portal, in the right DOM location', async function (assert) {
    await render(<template><Target id="test-app-side-nav-content" />
<Portal as |Nav|>
...
<Portal @ariaLabel="test">
  ...
  test('it marks inactive subnavs', async function (assert) {
    await render(<template><Target />
<Portal data-test-app-side-nav-panel as |Nav|>
...
<Portal data-test-app-side-nav-panel as |Nav|>
  ...
  test('it sets transform on the container', async function (assert) {
    await render(<template>
      <Target id="test-app-side-nav-content" />
      <Portal as |Nav|>
