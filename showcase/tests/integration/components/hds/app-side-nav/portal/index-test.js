...
module('Integration | Component | hds/app-side-nav/portal', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      hbs`<Hds::AppSideNav::Portal::Target id="test-side-nav-portal-target" />`
    );
    assert
  ...
  test('we can use custom a custom name for the target portal', async function (assert) {
    await render(hbs`
      <Hds::AppSideNav::Portal::Target @targetName="test-side-nav-portal-target" />
      <Hds::AppSideNav::Portal @targetName="test-side-nav-portal-target">
        <div id="test-side-nav-content-portaled" />
      </Hds::AppSideNav::Portal>
    `);
    assert.dom('#test-side-nav-content-portaled').exists();
  ...
  test('it renders the panel items provided via portal, in the right DOM location', async function (assert) {
    await render(hbs`
      <Hds::AppSideNav::Portal::Target id="test-side-nav-content" />
  ...
  test('it marks inactive subnavs', async function (assert) {
    await render(hbs`
      <Hds::AppSideNav::Portal::Target />
      <Hds::AppSideNav::Portal data-test-side-nav-panel as |Nav|>
