...
module(
  'Integration | Component | hds/app-side-nav/home-link',
  function (hooks) {
    ...
    test('it renders the passed in args', async function (assert) {
      await render(
        hbs`<Hds::AppSideNav::Header::HomeLink @icon="hashicorp" @ariaLabel="Hashicorp" @href="https://www.hashicorp.com/" id="test-home-link" />`
      );
    ...
    test('it renders the logo with a custom passed in color', async function (assert) {
      await render(
        hbs`<Hds::AppSideNav::Header::HomeLink @icon="boundary" @ariaLabel="Boundary" @color="var(--token-color-boundary-brand)" @href="#" />`
      );
      assert
    ...
    test('it should throw an assertion if @ariaLabel is missing/has no value', async function (assert) {
      ...
      await render(
        hbs`<Hds::AppSideNav::Header::HomeLink @icon="hashicorp" />`
      );
