...
module(
  'Integration | Component | hds/app-side-nav/icon-button',
  function (hooks) {
    ...
    test('it should render the component with a CSS class that matches the component name', async function (assert) {
      await render(
        hbs`<Hds::AppSideNav::Header::IconButton @icon="search" @ariaLabel="Search" id="test-side-nav-icon-button" />`
      );
      assert
    ...
    test('it renders the passed in args', async function (assert) {
      await render(
        hbs`<Hds::AppSideNav::Header::IconButton @icon="search" @ariaLabel="Search" id="test-side-nav-button" />`
      );
    ...
    test('it should render a <a> link if @href is passed', async function (assert) {
      await render(
        hbs`<Hds::AppSideNav::Header::IconButton @icon="search" @ariaLabel="Search" @href="https://www.hashicorp.com/" id="test-side-nav-button" />`
      );
      assert
    ...
    test('it should render a <a> link if @route is passed', async function (assert) {
      await render(
        hbs`<Hds::AppSideNav::Header::IconButton @icon="search" @ariaLabel="Search" @route="utilities.interactive" id="test-side-nav-button" />`
      );
      assert
        .dom('#test-side-nav-button')
        .hasTagName('a')
    ...
    test('it should throw an assertion if @ariaLabel is missing/has no value', async function (assert) {
      ...
      await render(hbs`<Hds::AppSideNav::Header::IconButton @icon="search" />`);
