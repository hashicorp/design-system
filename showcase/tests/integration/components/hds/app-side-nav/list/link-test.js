...
module(
  ...
  function (hooks) {
    ...
    // DISABLEtest('it renders the link as "active" if @isActive is true', async function (assert) {
    //   await render(
    ...
    // DISABLEtest('it renders the passed in custom content', async function (assert) {
    //   await render(hbs`
    ...
    // DISABLEtest(
    //   'it should render a <a> link if @route is passed',
