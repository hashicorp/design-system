...
module(
  ...
  function (hooks) {
    ...
    // DISABLEtest('it renders passed in yielded content', async function (assert) {
    //   await render(hbs`
    ...
    //   DISABLEtest('it has the role of "list" role so Safari will identify it correctly as a list since the list-style is changed in the CSS', async function (assert) {
    //     await render(hbs`
    //     <Hds::AppSideNav::List />
    //   `);
