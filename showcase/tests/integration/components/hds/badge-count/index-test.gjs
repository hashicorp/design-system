...
import BadgeCount from "@hashicorp/design-system-components/components/hds/badge-count/index";
...
module('Integration | Component | hds/badge-count/index', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      <template><BadgeCount @text="text renders" id="test-badge-count" /></template>,
    );
  ...
  test('it should have the correct color class based on the @color prop', async function (assert) {
    await render(
      <template><BadgeCount @text="text renders" id="test-badge-count" @color="neutral-dark-mode" /></template>,
    );
    assert
  ...
  test('it should have the correct size class based on the @size prop', async function (assert) {
    await render(
      <template><BadgeCount @text="text renders" id="test-badge-count" @size="small" /></template>,
    );
  ...
  test('it should have the correct type class based on the @type prop', async function (assert) {
    await render(
      <template><BadgeCount @text="text renders" id="test-badge-count" @type="inverted" /></template>,
    );
