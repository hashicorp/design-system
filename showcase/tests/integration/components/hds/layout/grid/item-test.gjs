...
import Item from "@hashicorp/design-system-components/components/hds/layout/grid/item";
...
module('Integration | Component | hds/layout/grid/item', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(<template><Item id="test-layout-grid-item" /></template>);
  ...
  test('it should render the yielded content', async function (assert) {
    await render(
      <template><Item id="test-layout-grid-item"><pre>test</pre></Item></template>,
    );
  ...
  test('it should render as yielded contextual component', async function (assert) {
    await render(
      <template><Grid as |LG|><LG.Item id="test-layout-grid-item"><pre>test</pre></LG.Item></Grid></template>,
    );
    assert.dom('#test-layout-grid-item > pre').exists().hasText('test');
  });
  ...
  test('it should render with a "div" element if @tag is not declared', async function (assert) {
    await render(
      <template><Grid as |LG|><LG.Item id="test-layout-grid-item" /></Grid></template>,
    );
  ...
  test('it should render with the correct @tag declared', async function (assert) {
    await render(
      <template><Grid as |LG|><LG.Item id="test-layout-grid-item" @tag="span" /></Grid></template>,
    );
  ...
  test('it should render the correct column span if the @colspan prop is declared', async function (assert) {
    await render(
      <template><Item id="test-layout-grid" @colspan={{2}} /></template>,
    );
    assert
  ...
  test('if the @rowspan prop is not declared, --hds-layout-grid-row-span should be unset', async function (assert) {
    await render(<template><Item id="test-layout-grid" /></template>);
    assert
      .dom('#test-layout-grid')
  ...
  test('it should render the correct row span if the @rowspan prop is declared', async function (assert) {
    await render(
      <template><Item id="test-layout-grid" @rowspan={{2}} /></template>,
    );
    assert
      .dom('#test-layout-grid')
