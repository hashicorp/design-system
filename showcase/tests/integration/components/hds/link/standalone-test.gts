...
module('Integration | Component | hds/link/standalone', function (hooks) {
  ...
  test('it should render the component with a CSS class that matches the component name', async function (assert) {
    await render(
      <template>
        <Standalone @text="watch video" @href="/" @icon="film" id="test-link" />
      </template>,
    );
  ...
  test('it should throw an assertion if there is no @icon defined', async function (assert) {
    ...
    await render(
      <template>
        {{! @glint-expect-error - testing invalid component usage }}
        <Standalone @href="/" @text="watch video" />
      </template>,
    );
    assert.throws(function () {
      throw new Error(errorMessage);
  ...
  test('it should throw an assertion if an incorrect value for @size is provided', async function (assert) {
    ...
    await render(
      <template>
        {{! @glint-expect-error - testing invalid component usage }}
        <Standalone @icon="film" @text="watch video" @href="/" @size="tiny" />
      </template>,
    );
    assert.throws(function () {
      throw new Error(errorMessage);
  ...
  test('it should throw an assertion if an incorrect value for @color is provided', async function (assert) {
    ...
    await render(
      <template>
        {{! @glint-expect-error - testing invalid component usage }}
        <Standalone @icon="film" @text="watch video" @href="/" @color="foo" />
      </template>,
    );
    assert.throws(function () {
      throw new Error(errorMessage);
