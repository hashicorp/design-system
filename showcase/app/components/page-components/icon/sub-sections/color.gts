...
const SubSectionColor: TemplateOnlyComponent = <template>
  ...
  <ShwFlex @direction="column" as |SF|>
    <SF.Item as |SFI|>
      ...
      <div>
        <HdsIcon @name="hexagon-fill" @size="24" />
      </div>
    </SF.Item>
    <SF.Item as |SGI|>
    ...
    {{#each COLORS as |color|}}
      <SG.Item @label={{color}}>
        <div class="shw-component-icon-sample-color--{{color}}">
          <HdsIcon @name="hexagon-fill" @color={{color}} @size="24" />
        </div>
      </SG.Item>
    {{/each}}
  </ShwGrid>
  ...
  <ShwFlex @direction="column" as |SF|>
    <SF.Item as |SGI|>
      ...
      <HdsIcon @name="hexagon-fill" @color="#e91e63" @size="24" />
    </SF.Item>
    <SF.Item as |SGI|>
    ...
    <SF.Item as |SGI|>
      ...
      <div {{style color="green !important"}}>
        <HdsIcon @name="hexagon-fill" @color="orange" @size="24" />
      </div>
    </SF.Item>
  </ShwFlex>
