...
export interface AdvancedTableWithPaginationSignature {
  Args: {
...
export default class AdvancedTableWithPagination extends Component<AdvancedTableWithPaginationSignature> {
  uuid = guidFor(this);
  ...
  @deepTracked model = [
    ...(this.args.hasPagination ? userData.slice(0, 16) : userData.slice(0, 4)),
  ];
