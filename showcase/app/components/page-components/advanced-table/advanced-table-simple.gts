...
export interface AdvancedTableSimpleSignature {
  Args: {
...
export default class AdvancedTableSimple extends Component<AdvancedTableSimpleSignature> {
  model = userData.slice(0, 4);
