...
import CodeFragmentWithSingleFieldElement, {
  type ClusterSizeOption,
} from 'showcase/components/page-components/form/super-select/code-fragments/with-single-field-element';
...
class SubSectionSingleFieldElement extends Component {
