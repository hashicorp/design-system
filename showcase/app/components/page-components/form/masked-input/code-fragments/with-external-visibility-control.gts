...
export interface CodeFragmentWithExternalVisibilityControlSignature {
  Element: HTMLDivElement;
}

export default class CodeFragmentWithExternalVisibilityControl extends Component<CodeFragmentWithExternalVisibilityControlSignature> {
