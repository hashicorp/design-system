    ...
    {{#if this.showIntro}}
      ...
      <ShwLabel {{style margin-bottom="32px"}}>
        ...
        <ul {{style line-height="1.5"}}>
          ...
          <li>Add a second "Tag" and fill its "Tag name" field using a different name and submit → The form should be submitted</li>
          <li>Add a third "Tag" and fill its "Tag name" field with the same value as the first tag and submit → A validation error should appear below the two duplicate "Tag name" fields</li>
          <li>Delete one of the duplicate tags and submit → The form should be submitted</li>
          ...
          <li>You can now repeat the previous steps about adding/deleting rows → See how the "delete button" works for the different rows, including when the last row has content and the tag fields are filled in that row</li>
        </ul>
      </ShwLabel>
    {{/if}}
