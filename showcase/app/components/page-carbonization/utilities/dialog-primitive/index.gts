      ...
      <:theming>
        <div class="shw-utility-dialog-primitive-overlay-container">
          <div class="shw-utility-dialog-primitive-overlay-mock-content">
            <HdsBadge @icon="activity" @text="Lorem ipsum" @color="highlight" />
            <HdsTextBody @tag="p" @size="200">Some
              <HdsLinkInline @href="#" @color="primary">generic</HdsLinkInline>
              content
              <HdsLinkInline @href="#" @color="secondary">here</HdsLinkInline>
            </HdsTextBody>
            <HdsButton
              @text="Primary"
              @icon="plus"
