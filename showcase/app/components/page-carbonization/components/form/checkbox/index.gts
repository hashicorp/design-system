  ...
  <section>
    ...
    {{#each STATES as |state|}}
      ...
      >
        ...
        <:reference>
          <cds-checkbox-group>
            <cds-checkbox checked>This is the label</cds-checkbox>
            <cds-checkbox helper-text="This is the helper text" checked>This is
              the label</cds-checkbox>
            <cds-checkbox invalid-text="This is the error" invalid>This is the
              label</cds-checkbox>
            <cds-checkbox
    ...
    {{#each (array "vertical" "horizontal") as |layout|}}
      <ShwTextH3>{{capitalize layout}} layout</ShwTextH3>

      <ShwCarbonizationComparisonGrid
        @label="With legend"
        @layout={{if (eq layout "horizontal") "column"}}
      >
        <:theming>
          <HdsFormCheckboxGroup
            @layout={{if (eq layout "horizontal") "horizontal"}}
            @name="group-{{layout}}-legend"
            as |G|
          >
        ...
        <:reference>
          <cds-checkbox-group
            ...
            orientation={{if (eq layout "horizontal") "horizontal"}}
          >
      ...
      >
        <:theming>
          ...
          >
            ...
            <G.CheckboxField checked="checked" disabled as |F|>
              <F.Label>Label of control #2</F.Label>
            </G.CheckboxField>
            <G.CheckboxField indeterminate={{true}} disabled as |F|>
              <F.Label>Label of control #3</F.Label>
            </G.CheckboxField>
          </HdsFormCheckboxGroup>
        </:theming>
        <:reference>
          <cds-checkbox-group
            ...
            orientation={{if (eq layout "horizontal") "horizontal"}}
          >
            <cds-checkbox disabled>Label of control #1</cds-checkbox>
            <cds-checkbox checked disabled>Label of control #2</cds-checkbox>
            <cds-checkbox indeterminate disabled>Label of control #3</cds-checkbox>
          </cds-checkbox-group>
        </:reference>
      </ShwCarbonizationComparisonGrid>
