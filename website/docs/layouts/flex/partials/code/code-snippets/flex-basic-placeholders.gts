...
const LocalComponent: TemplateOnlyComponent = <template>
  <HdsLayoutFlex>
    ...
    <DocPlaceholder @width="100%" @height="40px" @background="#e4c5f3">
      Other content
    </DocPlaceholder>
    <DocPlaceholder @width="100%" @height="40px" @background="#d2f4ff">
      More content
    </DocPlaceholder>
    <DocPlaceholder @width="100%" @height="40px" @background="#fff8d2">
      Extra content
    </DocPlaceholder>
  </HdsLayoutFlex>
</template>;
