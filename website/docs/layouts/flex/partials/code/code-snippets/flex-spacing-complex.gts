...
const LocalComponent: TemplateOnlyComponent = <template>
  <HdsLayoutFlex @wrap={{true}} @gap={{array "12" "24"}}>
    <DocPlaceholder @width="450px" @height="40px" @background="#e5ffd2">
      Some content
    </DocPlaceholder>
    <DocPlaceholder @width="250px" @height="40px" @background="#e4c5f3">
      Other content
    </DocPlaceholder>
    <DocPlaceholder @width="180px" @height="40px" @background="#d2f4ff">
      More content
    </DocPlaceholder>
