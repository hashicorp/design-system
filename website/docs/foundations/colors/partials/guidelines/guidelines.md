...
- `Foreground/Color/Strong` on `Surface/Color/Primary` nets a ratio of 19.54:1
- `Foreground/Color/Primary` on `Surface/Color/Primary` nets a ratio of 10.82:1
- `Foreground/Color/Action` on `Surface/Color/Faint` nets a ratio of 4.86:1
...
- `Foreground/Color/Strong` for headings and secondary links
- `Foreground/Color/Primary` for body text
- `Foreground/Color/Faint` for less prominent text and UI elements
- `Foreground/Color/Action` for primary calls to action such as links
...
- `Border/Color/Strong` for secondary Button border
- `Border/Color/Primary` for Card border or divider
- `Border/Color/{Status color}` for Alert borders
...
- `Surface/Color/Strong` for the Toggle background
- `Surface/Color/Primary` for component containers
- `Surface/Color/Faint` for the secondary Button
- `Surface/Color/{Status color}` for Alert backgrounds
...
Page colors are used for page backgrounds. HDS components do not use these tokens; however, we recommend `Page/Color/Primary` for all standard page backgrounds and `Page/Color/Faint` as a means to create a secondary level on a page if necessary.
