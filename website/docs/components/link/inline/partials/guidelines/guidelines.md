...
Since a component isn’t available for this within Figma, you will need to manually adjust the style of the text. To do this, select the text needed for the link, and change the decoration to "Underline".
