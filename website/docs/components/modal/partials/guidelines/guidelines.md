...
<Hds::Modal @size="medium" @color="critical" class="doc-modal-demo" open as |M|>
  ...
  <M.Footer>
    <Hds::ButtonSet>
      <Hds::Button type="submit" @text="Confirm" @color="critical" />
      <Hds::Button type="button" @text="Cancel" @color="secondary" />
    </Hds::ButtonSet>
  </M.Footer>
</Hds::Modal>
