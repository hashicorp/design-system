...
<Doc::ComponentApi as |C|>
  ...
  <C.Property @name="iconSecondary" @type="string">
    Use this parameter to show an extra “badge” with icon on top of the tile. Any [icon name](/icons/library) is acceptable. The color of the secondary icon is predefined and can’t be changed.
  </C.Property>
