...
<Doc::ComponentApi as |C|>
  ...
  <C.Property @name="...attributes">
    ...
    <br/><br/>
    Examples of HTML attributes: `id`, `name`, `value`, `disabled`, `required`, `multiple`. See [the whole list of HTML attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/select#attributes). Examples of Ember modifiers: `\{{on "change" [do something]}}`, `\{{on "blur" [do something]}}`.
  </C.Property>
</Doc::ComponentApi>
