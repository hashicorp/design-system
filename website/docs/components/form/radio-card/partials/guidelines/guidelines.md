...
<Hds::Form::RadioCard::Group @name="radio-card-horizontal-layout" as |G|>
  ...
  <G.RadioCard @checked={{true}} {{on "change" this.onChange}} as |R|>
    <R.Icon @name="arrow-right" @color="var(--hds-foreground-color-success)" />
