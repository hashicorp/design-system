...
where the `@queryFunction` function will be something like this (this is just an example, you will have to adapt the code to how your routing and query parameters are handled, see a reference [here](https://github.com/hashicorp/cloud-ui/blob/f49947bab0422165804049a018a7198f2e8c97e3/engines/role-assignments/addon/components/page/list.gts#L254-L259) or [here](https://github.com/hashicorp/atlas/blob/d6f0feee5a603d16fb331e1d697d12191a9bc1a3/frontend/atlas/app/controllers/v2/organization/workspaces-beta.js#L62C3-L69C4)):
