...
Connect each option to the theming service so selection updates the theme immediately, and persist the selected preference in the method best suited for your application. In this example, the pereference is stored in `localStorage`. 
