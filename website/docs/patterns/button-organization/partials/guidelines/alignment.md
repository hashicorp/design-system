...
![Button alignment options](/assets/patterns/button-organization/alignment-methods.png =770x*)
!!!
...
![Left alignment example](/assets/patterns/button-organization/using-left-alignment.png =836x*)
...
![Button alignment reading pattern](/assets/patterns/button-organization/alignment-reading-pattern.png =770x*)
!!!
...
![Right alignment example](/assets/patterns/button-organization/using-right-alignment.png =836x*)
...
![Center alignment example](/assets/patterns/button-organization/using-center-alignment.png =770x*)
!!!
