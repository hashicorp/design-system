...
![Ordering from high priority](/assets/patterns/button-organization/order-high-low-priority.png =650x*)
!!!
...
![Destructive action order](/assets/patterns/button-organization/order-destructive-action.png =650x*)
!!!
...
![Button order through conversational style](/assets/patterns/button-organization/order-conversational-example.png =790x*)
...
![Suboptimal grouping](/assets/patterns/button-organization/suboptimal-grouping.png =650x*)
...
![Optimal order](/assets/patterns/button-organization/optimal-ordering.png =650x*)
...
![Multi-step progressive flow](/assets/patterns/button-organization/multi-step-progressive-flow.png =650x*)
...
![Stacked order](/assets/patterns/button-organization/stacked-ordering.png =650x*)
!!!
